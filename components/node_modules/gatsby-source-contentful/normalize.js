  ...
  locales.forEach(locale => {
    ...
    const entryNodes = entries.map(entryItem => {
      ...
      Object.keys(entryItemFields).forEach(entryItemFieldKey => {
        ...
        if (fieldType === `Text`) {
          const textNode = prepareTextNode(entryNode, entryItemFieldKey, entryItemFields[entryItemFieldKey], createNode, createNodeId);
      ...
      entryNode = Object.assign({}, entryItemFields, entryNode, {
        node_locale: locale.code // Get content digest of node.
